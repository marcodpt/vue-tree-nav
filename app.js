...
},{"vue":43,"vue-hot-reload-api":39,"vueify/lib/insert-css":44}],41:[function(require,module,exports){
(function (process){
/**
  * vue-router v3.0.1
  * (c) 2017 Evan You
...
},{"timers":38}],43:[function(require,module,exports){
...
},{"_process":37,"timers":38}],44:[function(require,module,exports){
...
new _vue2.default({
  router: router,
  data: {
    routes: _routes2.default.concat([{
      label: 'pi',
      href: '#/numbers/3/14'
    }, {
      label: 'e',
...
module.exports = {
  ...
  methods: {
    ...
    setLocation: function setLocation() {
      ...
      this.$data.path = '';
      (0, _keys2.default)(this.$data.links).sort().forEach(function (key) {
...
},{"./components/bar.vue":46,"vue":43,"vue-hot-reload-api":39}],49:[function(require,module,exports){
module.exports = [{
  path: '/colors',
  component: {
